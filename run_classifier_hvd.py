  ...
  if FLAGS.do_tfx_eval:
    ...
    for (i, prediction) in enumerate(result):
      ...
      if probabilities[0] > probabilities[1] and probabilities[0] > probabilities[2] and probabilities[0] > probabilities[3]:
        y_.append(0)
      elif probabilities[1] > probabilities[2] and probabilities[1] > probabilities[0] and probabilities[1] > probabilities[3]:
        y_.append(1)
      elif probabilities[2] > probabilities[0] and probabilities[2] > probabilities[1] and probabilities[2] > probabilities[3]:
        y_.append(2)        
      else:
        y_.append(3)
    ...
    with open(FLAGS.data_dir+'/incorrect.tsv', mode='w+', encoding='utf-8') as new_file:
      ...
      for idx, val in enumerate(y_):
        if val != y[idx]:
          new_file.write(str(y[idx])+"\t"+str(val)+"\t"+linecache.getline(FLAGS.data_dir+'/dev.tsv', idx+2))
